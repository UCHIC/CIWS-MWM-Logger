...
// Original firmware (Sparkfun LSM303C) functions that were patched (by D.H.) to work with new (Pololu) magnetometer sensor board:
void       readData(volatile SignalState_t* SignalState);
void initializeData(volatile SignalState_t* SignalState);

//
// old function names for SParkfun IMU sensor library
//
